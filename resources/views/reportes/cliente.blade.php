...
@section('title', 'Reporte - ' . $user->name)
...
<!-- Banner del Cliente/Contratista -->
<div class="user-banner">
    <div class="user-avatar">{{ strtoupper(substr($user->name, 0, 1)) }}</div>
    <div class="user-info">
        <h2>{{ $user->name }}</h2>
        <p>📧 {{ $user->email }}</p>
        <p>👤 {{ $user->role?->name ?? 'Sin rol' }}</p>
    </div>
</div>
...
<div class="section-card">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="7" style="text-align: center; color: var(--apple-gray); padding: 32px;">No hay cuentas para este cliente</td>
            </tr>
            @endforelse
        </tbody>
    </table>
